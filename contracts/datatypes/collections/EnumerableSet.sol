...
library EnumerableSet {
    ...
    function _remove(TinySet storage tinySet_, bytes4 value_) private returns (bool) {
        ...
        if (valueIndex != 0) { // Equivalent to contains(set, value)
            ...
            uint256 lastIndex_ = tinySet_._values.length - 1;
            ...
            delete tinySet_._indexes[value_];
     ...
     */
    function _length(TinySet storage tinySet_) private view returns (uint256) {
        return tinySet_._values.length;
    }
